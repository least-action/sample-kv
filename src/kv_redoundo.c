...
//                                 + 1 + 1 + 1
//                                 + LINE_DIGIT_LEN + 1;
// void kv_ru_add_remove (int tx_id, enum kv_ru_type ru_type, char *key, size_t key_len, char *value, size_t val_len, char *old_value, size_t old_len)
// {
//     ssize_t nr;
